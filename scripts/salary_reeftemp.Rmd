---
title: "Salary Logger Exploration"
...
#data readin
eb.files<-list.files('C:/Users/drewv/OneDrive - USNH/Documents/0_People/GradStudents/DrewVilleneuve/salary_loggers/envlogger_data')
...
for (i in 1:length(eb.files)){
  log<-read.csv(paste0("C:/Users/drewv/OneDrive - USNH/Documents/0_People/GradStudents/DrewVilleneuve/salary_loggers/envlogger_data/",eb.files[i]),
...
cop_mada<-terra::rast("cop_sst.nc")
